...
public abstract class Association extends BaseConnection {
     ...
     */
    public boolean showMultiplicities() {
     ...
     */
    public void setShowMultiplicities(boolean flag) {
        showMultiplicities = flag;
    }
     ...
     */
    public Label getMultiplicity1Label() {
        return multiplicity1Label;
    }
     ...
     */
    public Label getMultiplicity2Label() {
        return multiplicity2Label;
    }
    ...
    private Relation getRelation() {
        return (Relation) getModelElement();
    }
     ...
     * {@inheritDoc}
     */
    @Override public Label getLabelAt(double xcoord, double ycoord) {
        return null;
    }
     ...
     * {@inheritDoc}
     */
    private void drawRombus(DrawingContext drawingContext, AffineTransform rotationTransform,
        boolean filled) {
    ...
    public enum AssociationType {
        COMPOSITION, AGGREGATION, UNSPECIFIED
    }
