...
/**
 * This class implements a name label for an association. Associations have special name labels
 * which can display an arrow for reading directions.
 *
 * @author Wei-ju Wu
 * @version 1.0
 */
public class AssociationNameLabel extends AbstractCompositeNode implements Label, LabelSource {
