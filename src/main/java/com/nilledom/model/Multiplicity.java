...
public final class Multiplicity   {
    ...
    public static final Multiplicity ZERO_TO_ONE = Multiplicity.getBoundedInstance(0, 1);
    public static final Multiplicity N = Multiplicity.getUnboundedInstance(0);
    public static final Multiplicity ONE_TO_N = Multiplicity.getUnboundedInstance(1);
     ...
     */
    public static Multiplicity getDefaultInstance() {
        return ONE;
    }
     ...
     * @throws java.text.ParseException if str is not in the allowed format
     */
    public static Multiplicity getInstanceFromString(String str) throws ParseException {
    ...
    @Override public boolean equals(Object obj) {
        ...
        if (obj instanceof Multiplicity) {
            ...
            return lowerBound == other.lowerBound && ((!noUpperLimit && !other.noUpperLimit &&
                upperBound == other.upperBound) || (noUpperLimit && other.noUpperLimit));
        }
        return false;
    }
}
