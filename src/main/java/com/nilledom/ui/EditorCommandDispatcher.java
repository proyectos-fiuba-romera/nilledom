...
public class EditorCommandDispatcher implements AppCommandListener {
    ...
    private void initSelectorMap() {
        try {
            // Self-calls
            selectorMap.put("SHOW_GRID", new MethodCall(getClass().getMethod("showGrid")));
            selectorMap.put("SNAP_TO_GRID", new MethodCall(getClass().getMethod("snapToGrid")));
    ...
    public void showGrid() {
        getCurrentEditor().showGrid(getMenuManager().isSelected("SHOW_GRID"));
