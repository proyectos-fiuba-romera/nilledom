 ...
 * @version 1.0
 */
public class SetConnectionNavigabilityCommand extends AbstractUndoableEdit implements Command {
     ...
     */
    public SetConnectionNavigabilityCommand(DiagramEditorNotification aNotification,
        UmlConnection aConnection, RelationEndType theEndType, boolean flag) {
    ...
    private boolean getNavigability() {
        ...
        if (endType == RelationEndType.SOURCE) {
            ...
            return relation.isNavigableToElement2();
    }
    ...
    private void setNavigability(boolean flag) {
        ...
        if (endType == RelationEndType.SOURCE) {
            ...
            relation.setNavigableToElement2(flag);
    }
}
