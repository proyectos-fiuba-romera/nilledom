...
import com.nilledom.model.Multiplicity;
import com.nilledom.model.UmlRelation;
import com.nilledom.model.Relation.ReadingDirection;
 ...
 * @version 1.0
 */
@SuppressWarnings("PMD") public class EditAssociationDialog extends javax.swing.JDialog {
    ...
    private JComboBox multiplicityACb;
    private JComboBox multiplicityBCb;
     ...
     */
    public EditAssociationDialog(java.awt.Window parent, Association anAssociation, boolean modal) {
    ...
    private void myPostInit() {
        ...
        multiplicityACb.setSelectedItem(relation.getElement1Multiplicity().toString());
        multiplicityBCb.setSelectedItem(relation.getElement2Multiplicity().toString());
    }
    ...
    private String getAssociationName() {
        return assocNameTextField.getText();
    }
    ...
    private void transferDataToAssociation() {
        ...
        try {
            relation.setElement1Multiplicity(
                Multiplicity.getInstanceFromString(multiplicityACb.getSelectedItem().toString()));
            relation.setElement2Multiplicity(
                Multiplicity.getInstanceFromString(multiplicityBCb.getSelectedItem().toString()));
    ...
    private void initComponents() {
        ...
        jPanel1Layout.setHorizontalGroup(
            jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING).addGroup(
                jPanel1Layout.createSequentialGroup().addContainerGap()
                    .addComponent(noDirectionRadioButton).addGap(31, 31, 31)
                    .addComponent(l2rRadioButton).addGap(31, 31, 31).addComponent(r2lRadioButton)
                    .addContainerGap(163, Short.MAX_VALUE)));
        jPanel1Layout.setVerticalGroup(
            jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING).addGroup(
                jPanel1Layout.createSequentialGroup().addGroup(
                    jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                        .addComponent(noDirectionRadioButton).addComponent(l2rRadioButton)
        ...
        multiplicityACb.setModel(
            new javax.swing.DefaultComboBoxModel(new String[] {"0..1", "1", "*", "1..*"}));
                ...
                jPanel2Layout.createSequentialGroup().addContainerGap().addGroup(
                    ...
                    jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        .addGroup(jPanel2Layout.createSequentialGroup().addGap(10, 10, 10)
                            .addComponent(multiplicityACb, javax.swing.GroupLayout.PREFERRED_SIZE,
                                54, javax.swing.GroupLayout.PREFERRED_SIZE))
                        .addComponent(roleANameTextField, javax.swing.GroupLayout.PREFERRED_SIZE,
                            295, javax.swing.GroupLayout.PREFERRED_SIZE)).addGap(109, 109, 109)));
        ...
        jPanel3Layout.setHorizontalGroup(
            jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING).addGroup(
                jPanel3Layout.createSequentialGroup().addContainerGap().addGroup(
                    ...
                    .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED).addGroup(
                    jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        .addComponent(roleBNameTextField, javax.swing.GroupLayout.PREFERRED_SIZE,
                            295, javax.swing.GroupLayout.PREFERRED_SIZE).addGroup(
                        jPanel3Layout.createSequentialGroup().addGap(10, 10, 10)
                            .addComponent(multiplicityBCb, javax.swing.GroupLayout.PREFERRED_SIZE,
            ...
            layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING).addGroup(
                layout.createSequentialGroup().addGroup(
                    layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING).addGroup(
                        layout.createSequentialGroup().addContainerGap().addGroup(
                            layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                .addGroup(layout.createSequentialGroup()
                                    .addComponent(associationNameLabel).addPreferredGap(
                                        javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                    .addComponent(assocNameTextField,
                        ...
                        layout.createSequentialGroup().addContainerGap().addComponent(showRolesCb)
                            .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                            .addComponent(showMultiplicitiesCb))
                        .addComponent(jPanel2, javax.swing.GroupLayout.DEFAULT_SIZE, 500,
                            Short.MAX_VALUE)
                        .addComponent(jPanel3, javax.swing.GroupLayout.DEFAULT_SIZE, 500,
                            Short.MAX_VALUE)).addContainerGap()));
        layout.setVerticalGroup(
            layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING).addGroup(
                layout.createSequentialGroup().addContainerGap().addGroup(
                    layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                        .addComponent(associationNameLabel).addComponent(nameVisibilityCb)
                        .addComponent(assocNameTextField, javax.swing.GroupLayout.PREFERRED_SIZE,
                            javax.swing.GroupLayout.DEFAULT_SIZE,
                            javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                    ...
                    .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED).addGroup(
                    layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                        .addComponent(showRolesCb).addComponent(showMultiplicitiesCb))
                    .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
