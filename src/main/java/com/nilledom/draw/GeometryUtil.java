...
public final class GeometryUtil {
     ...
     */
    public boolean rangesOverlap(double r1start, double r1end, double r2start, double r2end) {
     ...
     */
    public void computeLineIntersection(Line2D line0, Line2D line1, Point2D intersectionPoint) {
