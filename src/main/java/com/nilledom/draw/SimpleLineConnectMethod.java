...
public final class SimpleLineConnectMethod implements LineConnectMethod {
    ...
    private static SimpleLineConnectMethod instance = new SimpleLineConnectMethod();
     ...
     */
    public static SimpleLineConnectMethod getInstance() {
        return instance;
    }
     ...
     * {@inheritDoc}
     */
    public void generateAndSetPointsToConnection(Connection conn, Node node1, Node node2,
