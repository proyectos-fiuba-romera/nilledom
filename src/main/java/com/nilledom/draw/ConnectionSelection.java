...
public abstract class ConnectionSelection implements Selection {
     ...
     */
    protected boolean isDragControlPoint() {
        return isDragControlPoint;
    }
     ...
     */
    protected boolean isDragSegment() {
        return isDragSegment;
    }
    ...
    public void draw(DrawingContext drawingContext) {
        ...
        for (Point2D point : connection.getPoints()) {
            drawingContext.fillRectangle(point.getX() - 2, point.getY() - 2, 5, 5, Color.BLACK);
        }
    }
