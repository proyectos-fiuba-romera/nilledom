...
public class Compartment extends AbstractCompositeNode implements CompositeNode {
     ...
     */
    public void setAlignment(Alignment anAlignment) {
    ...
    public void recalculateSize(DrawingContext drawingContext) {
        ...
        double verticalLabelSpace = marginTop + Defaults.getInstance().getMarginBottom();
        ...
        double horizontalLabelSpace = maxLabelWidth + Defaults.getInstance().getMarginSide();
     ...
     * @param verticalLabelSpace   the vertical space that is used by labels
     */
    private void adjustSize(double horizontalLabelSpace, double verticalLabelSpace) {
    ...
    public void draw(DrawingContext drawingContext) {
        ...
        drawingContext.drawRectangle(getAbsoluteX1(), getAbsoluteY1(), getSize().getWidth(),
            getSize().getHeight(), background);
        for (Label label : labels) {
