...
/**
 * Label is a representation of a text label with one or more lines. It could in principle be
 * implemented as a JComponent. It is instead opted to keep it as light-weight as possible and
 * integrate it within the DiagramElement hierarchy.
 *
 * @author Wei-ju Wu
 * @version 1.0
 */
