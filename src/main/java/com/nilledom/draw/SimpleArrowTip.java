...
public class SimpleArrowTip {
    ...
    public void draw(DrawingContext drawingContext, Point2D endpoint,
        ...
        arrowPoint0.setLocation(endpoint.getX() - 10, endpoint.getY() - 4);
        arrowPoint1.setLocation(endpoint.getX() - 10, endpoint.getY() + 4);
        rotationTransform.transform(arrowPoint0, arrowPoint0);
        rotationTransform.transform(arrowPoint1, arrowPoint1);

        drawingContext
            .drawLine(arrowPoint0.getX(), arrowPoint0.getY(), endpoint.getX(), endpoint.getY());
        drawingContext
            .drawLine(arrowPoint1.getX(), arrowPoint1.getY(), endpoint.getX(), endpoint.getY());
    }
}
